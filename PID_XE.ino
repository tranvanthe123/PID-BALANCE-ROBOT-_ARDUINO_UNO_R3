...
#endif
double originalSetpoint = 174.5;// 181.13
double setpoint = originalSetpoint;
double movingAngleOffset = 0.3;// 0.3- OK, 0.15 - OK
double input, output;
...
#else
  PID pid(&input, &output, &setpoint,  40,1.6,140, DIRECT);// time 5ms & 10ms, sometimes Kp(17.35, 16.86) Ki(302.05, 301.05) Kd(1.21)//   30,330,0.4   17,33,0.4
#endif
